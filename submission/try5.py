...
model.fit_generator(train_generator, samples_per_epoch=(len(training_lines)//batch_size)*3*batch_size, validation_data=validation_generator, nb_val_samples=len(validation_lines), nb_epoch=5)
model.save('model.h5')